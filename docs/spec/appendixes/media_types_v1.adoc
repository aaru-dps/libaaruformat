[appendix]
== Annex E: Deprecated Media Types

NOTE: These values must not be used in new images.
They may still appear in legacy images.
For the most accurate and up-to-date list, refer to the `libaaruformat` source.
